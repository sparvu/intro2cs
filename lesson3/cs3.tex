...
\LARGE
\textbf{Data Structures}\\~\\
The fundamental data structure: sets. There can be two type of sets:
\begin{itemize}
    \item static 
    \item dynamic
\end{itemize}

Sets which are manipulated by algorithms can grow, shrink, change over time. We call these dynamic sets. 
\end{frame}
...
\begin{itemize}
    \item Empty set \{\}
    \item Set with 5 elements \{1,2,4,51,9\} 
    \item The set of natural numbers: $\mathbf{N} = \{0, 1, 2, 3, \ldots, \infty\}$
    \item The set of natural numbers except 0: $\mathbf{N*} = \{1, 2, 3, \ldots, \infty\}$
    \item The set of integers: $\mathbf{Z} = \{\ldots, -3, -2-, -1, 0, 1, 2, 3, \ldots, \infty\}$
    \item The set of integers: $\mathbf{Z} = \{\ldots, -3, -2-, -1, 0, 1, 2, 3, \ldots, \infty\}$
\end{itemize}
\end{frame}
